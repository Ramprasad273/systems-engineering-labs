...
SERVICE_NAME="surprisal-qlora-train"
...
${DOCKER_COMPOSE} run --rm ${SERVICE_NAME} python -c "
import transformers, bitsandbytes, peft, yaml, accelerate
print('All python dependencies (transformers, bitsandbytes, peft, accelerate, pyyaml) imported successfully!')
"
